...
module.exports = class TaskJobs {
  constructor(mpflowConfig) {
    this.src = mpflowConfig.src
    this.dist = mpflowConfig.dist
    this.less = mpflowConfig.compiler.less
    this.js = mpflowConfig.compiler.js
  ...
  copyFiles() {
    return () => {
      return gulp
        .src('**/*.{wxss,wxml,json,.config.json,.wxs}', {
          cwd: this.src,
          base: this.src,
        })
        .pipe(gulp.dest(this.dist))
  ...
  watch2Copy() {
    return () => {
      return gulp
        .watch('**/*.{wxss,wxml,json,.config.json,.wxs}', {
          base: this.src,
          cwd: this.src,
          delay: this.watchDelay,
        })
